...
$liza_rs_wrapper.each(function(){
    ...
    this_array.move = function(dir) {
        ...
        jQuery(this_obj.slider.find('.liza_ribbon_slide')[2]).addClass('active');
        this_obj.set.call(this_obj);
